...
from staff.models import *   # we call the model in the shop that is products and categorys
...
class items(models.Model):
    prod=models.ForeignKey(Medicine,on_delete=models.CASCADE)    #here class/tale product from shop is act as a foreign key so we can fetch the values ...
